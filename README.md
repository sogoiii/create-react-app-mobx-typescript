Purpose:
-----
The project uses react-app-rewired, react-app-rewire-mobx, and react-app-rewire-typescript to reconfigure the original create-react-app script and enable mobx and typescript.
